  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        <div className="grid h-12 w-12 place-items-center rounded-full border border-[#D9B56D]/50"><Compass className="h-6 w-6" /></div>
  ...
  return <div className="space-y-5">
    ...
    <div className="relative overflow-hidden rounded-2xl border border-[#9B8256]/35 bg-[#FFF9E9]/80 p-4 shadow-sm">
      ...
      <div className="grid grid-cols-[76px_1fr] gap-4">
        <div className="grid h-24 place-items-center rounded-xl bg-[#132B43] text-[#E7C77F]"><Compass className="h-10 w-10" /></div>
